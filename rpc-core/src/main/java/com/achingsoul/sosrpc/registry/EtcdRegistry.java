...
public class EtcdRegistry implements Registry {
    ...
    public void init(RegistryConfig registryConfig) {
        // Initialize the client and KV client
    ...
    public void register(ServiceMetaInfo serviceMetaInfo) throws Exception {
        ...
        ByteSequence value = ByteSequence.from(
                JSONUtil.toJsonStr(serviceMetaInfo), StandardCharsets.UTF_8);
    ...
    public void unregister(ServiceMetaInfo serviceMetaInfo) {
        ...
        try {
            ...
            throw new RuntimeException("Service unregistration was interrupted", e);
        ...
        CronUtil.schedule("*/10 * * * * *", new Task() {
            ...
            public void execute() {
                ...
                for (String key : localRegisterNodeKeySet) {
                    try {
                        List<KeyValue> keyValues = kvClient.get(ByteSequence.from(
